 ...
 */
final class Version20220617142120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, book_id, author, content, commented_at FROM comment');
        ...
        $this->addSql('INSERT INTO comment (id, book_id, author, content, commented_at) SELECT id, book_id, author, content, commented_at FROM __temp__comment');
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN last_movies CLOB DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, birthday, last_connection FROM user');
        ...
        $this->addSql('INSERT INTO user (id, email, roles, password, birthday, last_connection) SELECT id, email, roles, password, birthday, last_connection FROM __temp__user');
